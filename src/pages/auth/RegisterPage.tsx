...
export const RegisterPage = () => {
    ...
    const handleGoogleLogin = async () => {
        try {
            ...
            // Note: Welcome email can be configured in EmailJS dashboard
            // to trigger automatically on new user registration
        } catch (err: any) {
                ...
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="mt-2 text-sm text-slate-600">
                            Únete hoy y comienza a reservar salidas increíbles.
                        </p>
                    </div>
